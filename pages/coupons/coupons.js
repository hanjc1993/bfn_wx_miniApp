...
Page({
  ...
  getInitialData: function () {
    ...
    wx.request({
      ...
      // url: 'http://v4-rzct.hw.icgear.net/rest/RzReissueCoupon/applyStoreForCoupon?couponId=65',
      method: 'GET',
      data: {
      ...
      success: function (res) {
        console.log("我的优惠券门店列表");
        console.log(res);
        // 后台正常返回
          var LevelOne = res.data.briefInfoDto.partStoreLst;
  ...
  */
  ...
  getDataIntegration: function (LevelAll, nameListNew){
    ...
    for (var index in nameListNew){
      ...
      // LevelAllNew.push(LevelAllNewTest);
